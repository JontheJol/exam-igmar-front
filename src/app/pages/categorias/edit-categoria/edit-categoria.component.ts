...
export class EditCategoriaComponent implements OnInit {
  ...
  obtenerCategoria(categoriaId: number): void {
    ...
    const endpoint = `https://6f6f-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/categories/${categoriaId}`;
  ...
  onSubmit(): void {
    if (this.categoriaForm.valid) {
      ...
      const endpoint = `https://6f6f-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/categories/${categoryId}/update`;
      const userData = {
