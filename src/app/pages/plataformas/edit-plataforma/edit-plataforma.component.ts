...
export class EditPlataformaComponent {
  ...
  obtenerPlataforma(plataformaId: number): void {
    ...
    const endpoint = `https://6f6f-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/platforms/${plataformaId}`;
  ...
  onSubmit(): void {
    if (this.plataformaForm.valid) {
      ...
      const endpoint = `https://6f6f-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/platforms/${platformId}/update`;
      const userData = {
