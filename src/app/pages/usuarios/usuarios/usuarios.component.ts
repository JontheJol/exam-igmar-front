...
export class UsuariosComponent {
  ...
  obtenerUsuarios() {
    const endpoint = 'https://1d45-2806-101e-d-a299-8cdf-231a-3509-a0a7.ngrok-free.app/api/users';
  ...
  eliminarUsuario(usuario: any) {
    const token = this.cookieService.get('authToken');
    const headers = new HttpHeaders().set('Authorization', `Bearer ${token}`);
    const endpoint = `https://1d45-2806-101e-d-a299-8cdf-231a-3509-a0a7.ngrok-free.app/api/users/${usuario.id}/deactivate`;
