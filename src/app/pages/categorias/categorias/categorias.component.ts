...
export class CategoriasComponent {
  ...
  obtenerCategorias() {
    const endpoint = 'https://570e-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/categories';
  ...
  eliminarCategoria(categorie: any) {
    ...
    const endpoint = `https://570e-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/categories/${categorie.id}/deactivate`;
