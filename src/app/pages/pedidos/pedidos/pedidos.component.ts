...
export class PedidosComponent {
  ...
  obtenerPedidos() {
    ...
    const endpoint = 'https://570e-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/orders';
  ...
  eliminarPedido(order: any) {
    const token = this.cookieService.get('authToken');
    const headers = new HttpHeaders().set('Authorization', `Bearer ${token}`);
    const endpoint = `https://570e-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/orders/${order.id}/deactivate`;
