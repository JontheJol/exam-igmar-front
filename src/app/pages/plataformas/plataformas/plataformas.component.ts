...
export class PlataformasComponent {
  ...
  obtenerPlataformas() {
    const endpoint = 'https://570e-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/platforms';
  ...
  eliminarPlataforma(platform: any) {
    const token = this.cookieService.get('authToken');
    const headers = new HttpHeaders().set('Authorization', `Bearer ${token}`);
    const endpoint = `https://570e-2806-101e-d-a299-c169-f1b5-8ce1-acf5.ngrok-free.app/api/platforms/${platform.id}/deactivate`;
